...
#    Updated: 2022/07/27 19:12:37 by mbouthai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXTERN	:= -Ilibft/ -Ift_printf/ -Iget_next_line/ -I/usr/include -Imlx_linux
...
LFLAGS	:= -L./libft -L./ft_printf -Lmlx_linux -L/usr/lib -lft -lftprintf -lmlx_Linux -lXext -lX11 -lm -lz 
